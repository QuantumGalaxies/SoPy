...
* **`Vector.gaussian(amplitude, positions, sigmas, angulars, lattices)`**
    ...
    * **angulars**: Angular momentum quantum numbers.
...
Used for the exp_i(k x) space and Fourier operations.
